...
namespace FancyZonesUnitTests
{
    ...
    TEST_CLASS (FancyZonesSettingsUnitTests)
    {
        ...
        std::wstring serializedPowerToySettings(const Settings& settings)
        {
            ...
            ptSettings.add_bool_toggle(L"fancyzones_virtualDesktopChange_moveWindows", IDS_SETTING_DESCRIPTION_VIRTUALDESKTOPCHANGE_MOVEWINDOWS, settings.virtualDesktopChange_moveWindows);
        ...
        TEST_METHOD_INITIALIZE(Init)
            {
                ...
                m_ptSettings->add_bool_toggle(L"fancyzones_virtualDesktopChange_moveWindows", IDS_SETTING_DESCRIPTION_VIRTUALDESKTOPCHANGE_MOVEWINDOWS, expected.virtualDesktopChange_moveWindows);
